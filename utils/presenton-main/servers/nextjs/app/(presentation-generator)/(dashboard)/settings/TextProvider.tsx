...
const TextProvider = ({
    ...
    const shouldUseManualModelInput =
        isManualModelProvider || (selectedProvider === 'custom' && modelsChecked && availableModels.length === 0);
            ...
            if (selectedProvider === 'google') {
                ...
                response = await fetch(getApiUrl('/api/v1/ppt/openai/models/available'), {
                    ...
                    body: JSON.stringify({
                        ...
                        api_key: currentApiKey,
                        allow_empty_on_error: selectedProvider === 'custom'
                    }),
                });
            }
            ...
            if (response.ok) {
                ...
                if (selectedProvider === 'custom') {
                    notify.info(
                        ...
                        'Enter the custom model name manually.'
                    );
                } else {
                    notify.error(
        ...
        <div className="space-y-6 bg-[#F9F8F8] p-7 rounded-[12px] ">
            ...
            <div className="mb-4 flex items-end justify-between rounded-[12px] bg-white pt-5 pb-10 px-10">
                ...
                <div className='flex flex-col justify-end items-end gap-4'>
                    ...
                    {!shouldUseManualModelInput && selectedProvider !== 'codex' && modelsChecked && availableModels.length > 0 ? (
            ...
            {!isManualModelProvider && modelsChecked && availableModels.length === 0 && (
                <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-sm text-yellow-800">
                        {selectedProvider === 'custom'
                            ? 'No models were returned by this custom endpoint. You can enter the model name manually.'
